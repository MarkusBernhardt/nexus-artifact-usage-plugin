...
public interface ArtifactUsageStore {
     ...
     * following Artifacts.
     *
     * @param artifact The artifact that depends on the rest
     * @param dependencies The artifacts that are depended upon
     * @param artifactPath
     */
     ...
     *
     * @param artifact The artifact being removed from the repository
     */
     ...
     *
     * @param path location of the artifact for identification purposes
     * @param lastModifiedTime the time in milliseconds that the file was last
     * modified
