...
//            logger.info("dependency storage: " + artifactUsageStore.toString());
        }
        return result;
    }
    ...
    public void calculateArtifactUsage(final StorageFileItem item) throws IOException {
        ...
        if (artifact != null) {
            artifactUsageStore.addDependencies(artifact, dependencyResolver.resolveDependencies(artifact, item.getRepositoryId()),
