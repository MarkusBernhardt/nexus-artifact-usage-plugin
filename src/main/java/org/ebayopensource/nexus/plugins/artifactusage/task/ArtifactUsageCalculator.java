...
public interface ArtifactUsageCalculator {
     ...
     *
     * @param request defines the repository or repository group to process
     * @return list of artifacts that were processed
     * @throws NoSuchRepositoryException if the specified repository does not
     * exist
     * @throws IllegalArgumentException if the specified repository is not a
     * Maven repository
     */
     ...
     *
     * @param item the artifact to process
